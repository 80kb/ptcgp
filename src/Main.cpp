...
int main (void) {
	...
	pkmCard card0( gameState.GetRenderer(), "./res/img/darkrai.bmp" );
	card0.SetPosition( 100, 400 );
	card0.Show();
	cards.push_back( &card0 );

	pkmCard card1( gameState.GetRenderer(), "./res/img/darkrai.bmp" );
	card1.SetPosition( 180, 400 );
	cards.push_back( &card1 );

	pkmCard card2( gameState.GetRenderer(), "./res/img/darkrai.bmp" );
	card2.SetPosition( 260, 400 );
	cards.push_back( &card2 );

	pkmCard card3( gameState.GetRenderer(), "./res/img/darkrai.bmp" );
